...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/MI_AOD/yolo_world_l_MIAOD_4x8x4_Pretrain.py', help='test config file path')
    parser.add_argument('--checkpoint', default='work_dirs/MI-AOD/Pretrain/epoch_20.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
        default='work_dirs/test_debug',
