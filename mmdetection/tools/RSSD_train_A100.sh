...
export CONFIG=configs/mm_grounding_dino/RSSD/grounding_dino_swin-t_finetune_1x8x4_1x_RSSD_A100.py
...
#     --launcher pytorch \
#     --amp 
CUDA_VISIBLE_DEVICES=3,4,5,6 ./tools/dist_train.sh ${CONFIG} 4 --amp