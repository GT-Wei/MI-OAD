...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', type=str, 
        default='/home/disk1/code/mmdetection/demo/P0020__723__1480.png',
        help='Input image file or folder path.')
    parser.add_argument(
        '--model',
        type=str,
        default='configs/mm_grounding_dino/RSSD/val/grounding_dino_swin-t_Detection_Types_ZSD.py',
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='pretrain_model/grounding_dino_swin-t_pretrain_obj365_goldg_grit9m_v3det_20231204_095047-b448804b.pth', help='Checkpoint file')
    ...
    # a medium-sized ship with a white hull is situated in a body of water, surrounded by dark water and small ripples, located in the top, far right of the image.
    call_args['texts'] = [['a harbor at the lower middle of the image.']]
    # A white wheeled transport commonly used for travel on roads, located at the bottom of the image.
